...
hashpipe_databuf_t *demo2_output_databuf_create(int instance_id, int databuf_id);

static inline void demo2_output_databuf_clear(demo2_output_databuf_t *d)
{
    hashpipe_databuf_clear((hashpipe_databuf_t *)d);
}

static inline demo2_output_databuf_t *demo2_output_databuf_attach(int instance_id, int databuf_id)
{
    return (demo2_output_databuf_t *)hashpipe_databuf_attach(instance_id, databuf_id);
}

static inline int demo2_output_databuf_detach(demo2_output_databuf_t *d)
{
    return hashpipe_databuf_detach((hashpipe_databuf_t *)d);
}

static inline int demo2_output_databuf_block_status(demo2_output_databuf_t *d, int block_id)
{
    return hashpipe_databuf_block_status((hashpipe_databuf_t *)d, block_id);
}

static inline int demo2_output_databuf_total_status(demo2_output_databuf_t *d)
{
    return hashpipe_databuf_total_status((hashpipe_databuf_t *)d);
}

static inline int demo2_output_databuf_wait_free(demo2_output_databuf_t *d, int block_id)
{
    return hashpipe_databuf_wait_free((hashpipe_databuf_t *)d, block_id);
}

static inline int demo2_output_databuf_busywait_free(demo2_output_databuf_t *d, int block_id)
{
    return hashpipe_databuf_busywait_free((hashpipe_databuf_t *)d, block_id);
}
static inline int demo2_output_databuf_wait_filled(demo2_output_databuf_t *d, int block_id)
{
    return hashpipe_databuf_wait_filled((hashpipe_databuf_t *)d, block_id);
}

static inline int demo2_output_databuf_busywait_filled(demo2_output_databuf_t *d, int block_id)
{
    return hashpipe_databuf_busywait_filled((hashpipe_databuf_t *)d, block_id);
}

static inline int demo2_output_databuf_set_free(demo2_output_databuf_t *d, int block_id)
{
    return hashpipe_databuf_set_free((hashpipe_databuf_t *)d, block_id);
}

static inline int demo2_output_databuf_set_filled(demo2_output_databuf_t *d, int block_id)
{
    return hashpipe_databuf_set_filled((hashpipe_databuf_t *)d, block_id);
}
